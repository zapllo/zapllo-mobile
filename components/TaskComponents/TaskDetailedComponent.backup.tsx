...
const handleSliderChange = async (value: number) => {
  ...
  const updateTask = async () => {
    ...
    try {
      ...
      // For errors, don't navigate back
      setTimeout(() => {
        setShowAlert(false);
      }, 3000);
    } finally {
  ...
  return (
    <>
      ...
      >
        <LinearGradient
          colors={['rgba(17, 17, 50, 0.95)', '#0A0D28']}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        ...
        >
          ...
          <View style={styles.dueDateContainer}>
            <MaterialIcons name="event" size={14} color="#787CA5" />
          ...
          <View style={styles.cardContent}>
            <View style={styles.infoColumn}>
              ...
              <View style={styles.infoItem}>
                <View style={styles.infoLabel}>
                  <MaterialCommunityIcons name="account-supervisor" size={16} color="#787CA5" />
                  <Text style={styles.labelText}>Assigned by</Text>
                </View>
                <Text style={styles.assignerValue} numberOfLines={1} ellipsizeMode="tail">
                  {assignedBy}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.infoColumn}>
              <View style={styles.infoItem}>
                <View style={styles.infoLabel}>
                  <Ionicons name="pricetag" size={16} color="#787CA5" />
              ...
              <View style={styles.infoItem}>
                <View style={styles.infoLabel}>
                  <MaterialIcons name="repeat" size={16} color="#787CA5" />
                  <Text style={styles.labelText}>Frequency</Text>
                </View>
                <Text style={styles.frequencyValue} numberOfLines={1} ellipsizeMode="tail">
