...
const AddMemberModal: React.FC<AddMemberModalProps> = ({
  ...
  useEffect(() => {
    if (visible) {
      ...
      setSelectedManager('');
      setSelectedCountry(countryData.find((c) => c.dial_code === '+91'));
      setErrors({
        firstName: '',
        lastName: '',
        email: '',
  ...
  const validateInputs = () => {
    const newErrors = {
      ...
      email: !newMember.email.trim() ? 'Email is required' : 
             !/\S+@\S+\.\S+/.test(newMember.email) ? 'Invalid email format' : '',
      whatsappNo: !newMember.whatsappNo.trim() ? 'WhatsApp Number is required' : '',
      password: !newMember.password.trim() ? 'Password is required' : 
                newMember.password.length < 6 ? 'Password must be at least 6 characters long' : '',
    };
  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        setTimeout(() => {
          console.log('Showing success splash screen for member creation');
      ...
      if (error.response?.data?.error) {
        ...
        if (msg === "User limit reached for the current plan.") {
          errorMessage = "You have reached the maximum number of members for your current plan";
  ...
  const handleSplashComplete = () => {
    console.log('Member creation splash screen completed');
  ...
  const renderReportingManagerOption = (manager: User) => (
    <TouchableOpacity
      ...
      style={[
        ...
        selectedManager === manager._id && styles.selectedManagerOption,
      ]}
      onPress={() => {
        Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
        setSelectedManager(manager._id);
        setNewMember({ ...newMember, reportingManager: manager._id });
      }}
    >
      <Text
        style={[
          styles.managerOptionText,
          selectedManager === manager._id && styles.selectedManagerOptionText,
        ]}
      >
  ...
  return (
    <>
              ...
              <View style={styles.header}>
                <View style={styles.headerContent}>
                  <View style={styles.headerIcon}>
                    <MaterialIcons name="person-add" size={24} color="#815BF5" />
                  </View>
              ...
              >
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.fullWidthInputContainer}>
                    <InputContainer
                      ...
                      onChangeText={(text) => {
                        setNewMember({ ...newMember, whatsappNo: text });
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.fullWidthInputContainer}>
                    ...
                    <View style={styles.roleContainer}>
                      ...
                      {currentUser?.role === 'orgAdmin' && renderRoleOption('orgAdmin', 'Admin')}
                    </View>
                  </View>
                    ...
                    <View style={styles.fullWidthInputContainer}>
                      ...
                      >
                        <TouchableOpacity
                          style={[
                            styles.managerOption,
                            !selectedManager && styles.selectedManagerOption,
                          ]}
                          onPress={() => {
                            Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                            setSelectedManager('');
                            setNewMember({ ...newMember, reportingManager: '' });
                          }}
                        >
                          <Text
                            style={[
                              styles.managerOptionText,
                              !selectedManager && styles.selectedManagerOptionText,
                            ]}
                          >
                        ...
                        {users
                          .filter(u => u.role === 'manager' || u.role === 'orgAdmin')
                ...
                <View style={styles.section}>
                  ...
                  {renderAccessToggle(
                    ...
                    newMember.isTaskAccess,
                    (value) => setNewMember({ ...newMember, isTaskAccess: value }),
                    'assignment'
                  )}
                  ...
                  {renderAccessToggle(
                    ...
                    newMember.isLeaveAccess,
                    (value) => setNewMember({ ...newMember, isLeaveAccess: value }),
                  ...
                  >
                    {isLoading ? (
                      <>
                        ...
                        <Text style={styles.saveButtonText}>Adding Member...</Text>
                      </>
                    ) : (
      ...
      <CustomSplashScreen
        ...
        mainText="Member Added!"
        subtitle="New team member has been added successfully."
