        ...
        >
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputGroup}>
              <Text style={[styles.inputLabel, (focusedInput === 'linkName' || formData.linkName.length > 0) && styles.inputLabelFocused]}>Link Name *</Text>
              <TextInput
                style={[styles.input, focusedInput === 'linkName' && styles.inputFocused]}
                placeholder={focusedInput === 'linkName' ? "Enter link name" : ""}
                placeholderTextColor="#787CA5"
                value={formData.linkName}
                onChangeText={(text) => setFormData(prev => ({...prev, linkName: text}))}
                onFocus={() => setFocusedInput('linkName')}
                onBlur={() => setFocusedInput('')}
              />
            </View>

            <View style={styles.inputGroup}>
              <Text style={[styles.inputLabel, (focusedInput === 'linkUrl' || formData.linkUrl.length > 0) && styles.inputLabelFocused]}>URL *</Text>
              <TextInput
                style={[styles.input, focusedInput === 'linkUrl' && styles.inputFocused]}
                placeholder={focusedInput === 'linkUrl' ? "https://example.com" : ""}
                placeholderTextColor="#787CA5"
                value={formData.linkUrl}
                onChangeText={(text) => setFormData(prev => ({...prev, linkUrl: text}))}
                onFocus={() => setFocusedInput('linkUrl')}
                onBlur={() => setFocusedInput('')}
                keyboardType="url"
              />
            </View>
            ...
            <View style={styles.inputGroup}>
              <Text style={[styles.inputLabel, (focusedInput === 'description' || formData.description.length > 0) && styles.inputLabelFocused]}>Description *</Text>
              <TextInput
                style={[styles.input, styles.textArea, focusedInput === 'description' && styles.inputFocused]}
                placeholder={focusedInput === 'description' ? "Enter description" : ""}
                placeholderTextColor="#787CA5"
