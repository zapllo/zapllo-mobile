...
const DelegatedInprogressTask: React.FC<Props> = ({ navigation }) => {
  ...
  const applyFilter = () => {
    ...
    // setFilteredTasks(tasksMatchingFilters); // Uncomment if you have a state for filtered tasks
...
export default DelegatedInprogressTask;
