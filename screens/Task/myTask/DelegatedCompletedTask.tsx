...
type TodaysTaskScreenRouteProp = RouteProp<DelegatedTaskStackParamList, 'CompletedTask'>;
...
const DelegatedCompletedTask: React.FC<Props> = ({ navigation }) => {
  ...
  const { completedTasks } = route.params; // Safely access pendingTasks
  ...
  console.log('comppppp', completedTasks);
  ...
  return (
    <SafeAreaView className="h-full flex-1 bg-primary">
      ...
      <View className="flex h-20 w-full flex-row items-center justify-between p-5">
        ...
        <Text className="h-full pl-4 text-2xl font-semibold text-[#FFFFFF]">Completed Task</Text>
        <ProfileButton />
      </View>
